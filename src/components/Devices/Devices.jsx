...
function Content() {
  ...
  //     } else {
  //       return (
  //         item.Heading.toLowerCase().includes(searchval.toLowerCase()) ||
  //         item.name.toLowerCase().includes(searchval.toLowerCase()) ||
  //         item.id1.toLowerCase().includes(searchval.toLowerCase()) ||
  //         item.id2.toLowerCase().includes(searchval.toLowerCase()) ||
  //         item.pole.toLowerCase().includes(searchval.toLowerCase())
  //       );
  //     }
  //   });
